...
function Footer() {
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5
      m-auto item-start justify-center'>
      ...
      <div>
        ...
        <p className='text-white pb-[13px] opacity-70 leading-7'>
          We always make our seekers and companies find the best job and employers find 
          the best candidates.
        </p>
      </div>
      ...
      <div className="grid">
        ...
        <div>
          ...
          <AiFillInstagram className='text-blueColor bg-white p-2 h-[35px] w-[35px] rounded-full'/>
          <BsFacebook  className='bg-white h-[35px] w-[35px] p-2 rounded-full text-blueColor '/>
          <AiOutlineTwitter className='bg-white h-[35px] w-[35px] p-2 rounded-full text-blueColor '/>
          </div>
